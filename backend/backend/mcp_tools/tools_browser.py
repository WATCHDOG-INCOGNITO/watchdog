...
def register(mcp):
    ...
    @mcp.tool()
    def browser_get_network_log(filter_type: str = "") -> str:
    ...
    @mcp.tool()
    def browser_get_dom(selector: str = "body") -> str:
        """렌더링된 DOM에서 요소를 추출한다.
    ...
    @mcp.tool()
    def browser_fill_and_submit(selector_map: str, submit_selector: str = "") -> str:
        """폼 필드를 채우고 제출한다.
    ...
    @mcp.tool()
    def browser_extract_api_endpoints() -> str:
